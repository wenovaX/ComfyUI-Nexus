...
internal sealed class RuntimePackageService
{
	...
	internal async Task ExtractComfyZipDirectlyAsync(string zipPath, string targetPath, CancellationToken cancellationToken)
	{
	...
	private void KillInstalledRuntimeProcesses()
	{
#if !WINDOWS
