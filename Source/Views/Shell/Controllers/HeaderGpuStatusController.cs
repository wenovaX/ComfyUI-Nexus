...
namespace ComfyUI_Nexus.Views.Controllers;
...
internal sealed class HeaderGpuStatusController
{
	...
	internal HeaderGpuStatusController(VisualElement owner, HeaderView header, NexusAnimatedWebpFrameCache frameCache)
	{
		...
		_gpuIdleEnergyCoreClip = new NexusAnimatedWebpClip(_motion, frameCache, header.GpuIdleEnergyCoreImage, "HeaderGpu.IdleEnergyCore", NexusAnimatedWebpCacheCatalog.HeaderGpuIdle);
		_gpuRunningEnergyCoreClip = new NexusAnimatedWebpClip(_motion, frameCache, header.GpuRunningEnergyCoreImage, "HeaderGpu.RunningEnergyCore", NexusAnimatedWebpCacheCatalog.HeaderGpuRunning);
		_gpuGauge = new NexusFrameGauge(_motion, frameCache, header.GpuLoadFrameGaugeImage, "HeaderGpu.FrameGauge", NexusAnimatedWebpCacheCatalog.HeaderGpuFrameGauge);
		_vramGauge = new NexusFrameGauge(_motion, frameCache, header.VramFrameGaugeImage, "HeaderGpu.VramFrameGauge", NexusAnimatedWebpCacheCatalog.HeaderVramFrameGauge);
		_cpuGauge = new NexusFrameGauge(_motion, frameCache, header.CpuFrameGaugeImage, "HeaderGpu.CpuFrameGauge", NexusAnimatedWebpCacheCatalog.HeaderCpuFrameGauge);
	}
