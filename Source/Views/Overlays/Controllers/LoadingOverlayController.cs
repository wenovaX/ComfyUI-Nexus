...
namespace ComfyUI_Nexus.Views.Overlays.Controllers;
...
internal sealed class LoadingOverlayController
{
	...
	internal LoadingOverlayController(LoadingOverlayView overlay, HeaderView header, NexusAnimatedWebpFrameCache frameCache)
	{
		_overlay = overlay;
		_header = header;
		...
		_processClip = new NexusAnimatedWebpClip(_motion, _frameCache, _overlay.LoadingProcessAnimationSurface, "Loading.Process", NexusAnimatedWebpCacheCatalog.LoadingProcess);
		_successClip = new NexusAnimatedWebpClip(_motion, _frameCache, _overlay.SuccessAnimationSurface, "Loading.SuccessGate", NexusAnimatedWebpCacheCatalog.LoadingSuccess);
	}
	...
	private async Task EnsureAnimationCacheAsync()
	{
		...
		_animationCacheAcquireTask ??= _frameCache.AcquireAsync(NexusAnimatedWebpCacheGroup.Shell);
