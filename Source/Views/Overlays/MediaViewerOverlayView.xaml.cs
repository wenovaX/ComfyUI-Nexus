...
public partial class MediaViewerOverlayView : ContentView
{
		...
		Action? hideCallback = null)
	{
		...
		try
		{
			...
			this.AbortAnimation(ViewerFadeAnimationName);
			_items.Clear();
			...
			Opacity = 0;
			await this.FadeToAsync(1, ViewerShowFadeLength, Easing.CubicOut);
		}
	...
	public async Task HideAsync()
	{
		...
		try
		{
			...
			await this.FadeToAsync(0, ViewerHideFadeLength, Easing.CubicIn);
	...
	private async Task<bool> ShowConfirmDialogAsync(string title, string message)
	{
		...
		await ViewerConfirmLayer.FadeToAsync(1, ConfirmShowFadeLength, Easing.CubicOut);
	...
	private async Task HideConfirmDialogAsync()
	{
		...
		await ViewerConfirmLayer.FadeToAsync(0, ConfirmHideFadeLength, Easing.CubicIn);
