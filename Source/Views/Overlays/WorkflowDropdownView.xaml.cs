...
public partial class WorkflowDropdownView : ContentView
{
	...
	private Task AnimateDropdownAsync(double opacity, double offsetY, Easing easing)
		=> Task.WhenAll(
			SafeAnimation.FadeToAsync(CustomDropdownOverlayBorder, opacity, RevealAnimationLength, source: "WorkflowDropdown"),
			SafeAnimation.TranslateToAsync(CustomDropdownOverlayBorder, 0, offsetY, RevealAnimationLength, easing, "WorkflowDropdown"));
}
