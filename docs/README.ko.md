...
<p align="left">
  <img src="images/nexus-model-thumbnails.png" alt="ComfyUI Nexus 모델 썸네일 미리보기" width="100%">
</p>

언어: [English](../README.md) | [한국어](README.ko.md)

프로젝트 및 브랜딩 기준: [PROJECTINFO.ko.md](PROJECTINFO.ko.md)

릴리즈 변경 내역: [CHANGELOG.ko.md](CHANGELOG.ko.md)

## 설치

일반 사용자는 GitHub Release에 올라온 ZIP을 내려받아 폴더째 압축을 풀면 됩니다.

모든 포터블 release root에는 설치 위치, 최소·권장 사양, 이동 방법을 정리한
간단한 `README.txt`도 함께 들어 있습니다.
...
Git Bash를 사용하지 않는 경우에는 명령 프롬프트에서 `tools\windows\dev-set-version.bat`를 실행하면 됩니다.
...
[English](DEVELOPERS.md) | [한국어](DEVELOPERS.ko.md).
