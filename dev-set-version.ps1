...
function Get-NexusMauiVersionMapping {
	...
	return [pscustomobject]@{
		...
		ApplicationVersion = $parsedVersion.Revision
	}
}
...
try {
	...
	Write-Host ''
	Write-Host "[Nexus] Current version: $currentVersion" -ForegroundColor Cyan
	Write-Host "[Nexus] MAUI package mapping: display=$($currentMauiVersion.DisplayVersion), revision=$($currentMauiVersion.ApplicationVersion)" -ForegroundColor DarkGray
	...
	Write-Host "[Nexus] MAUI package mapping: display=$($newMauiVersion.DisplayVersion), revision=$($newMauiVersion.ApplicationVersion)" -ForegroundColor DarkGray
